...
A comprehensive embedded systems project combining firmware development and PCB hardware design for an autonomous delivery robot platform based on STM32F407VGTx.
